...
export default function EditCourse() {
    ...
    const existing = state?.course || {}
    const [formData, setFormData] = useState({
        courseName: existing.courseName || existing.name || '',
    ...
    if (!isAdmin) {
        return <div className="p-4"><div className="alert alert-danger">Access Denied: Only administrators can edit courses.</div></div>
    }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            navigate('/courses', { state: { page: state?.page } })
        } catch (err) {
    ...
    return (
        <div>
            <div className="form-card shadow-sm p-4 mt-3 col-lg-8 mx-auto">
                <h4 className="fw-bold mb-1" style={{ color: '#4f46e5' }}>Edit Course</h4>
                <p className="text-muted mb-4">Update the details for this course</p>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="d-flex justify-content-end gap-3 mt-4">
                        <button
                            ...
                            onClick={() => navigate('/courses', { state: { page: state?.page } })}
                        >
                            Cancel
                        </button>
                        <button
